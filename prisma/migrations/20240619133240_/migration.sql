/*
  ...
  - You are about to drop the column `enventId` on the `Spot` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `Spot` DROP FOREIGN KEY `Spot_enventId_fkey`;

-- AlterTable
ALTER TABLE `Spot` DROP COLUMN `enventId`,
